...
A la vista de los resultados concluimos que los umbrales son
leer como trozo, neurona y umbral bajo o alto. 

```{python}
from src.constants import THRESHOLD
import json
print(json.dumps(THRESHOLD, sort_keys=True, indent=4))
```
