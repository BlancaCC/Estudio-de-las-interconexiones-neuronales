...
Una representación gráfica de los mismos con un mapa de color sería la siguiente, tenga presente que a más claro mayor es la entropía: 
...
Mapa de color de Información mutua variando en función del número de 
...
El ancho de ventana en este problema se puede ampliar en tres aspectos: 

- **Tamaño de palabra para el cálculo de la información mutua**, lo que nosotros hemos denominado durante todo el experimento como bits $b$.  
- **Ta
